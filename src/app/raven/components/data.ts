...
export const statementContent =
  "Many students are facing significant challenges in their academic year due to the continued use of outdated and uninspiring studying methods. These traditional methods fail to engage students effectively, resulting in decreased motivation, lower academic performance, and hindered overall educational progress. Therefore, there is an urgent need to address this issue by exploring innovative, engaging, and more effective study techniques that can better support students in their pursuit of academic excellence.";
